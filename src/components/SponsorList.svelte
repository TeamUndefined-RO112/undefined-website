...
<style>
    ...
    .top-sponsor-card .corner-accent {
        position: absolute;
        width: 18px;
        height: 18px;
    ...
    .top-sponsor-card .corner-accent.top-left {
        top: 12px;
        left: 12px;
        border-right: none;
        border-bottom: none;
    ...
    .top-sponsor-card .corner-accent.top-right {
        top: 12px;
        right: 12px;
        border-left: none;
        border-bottom: none;
    ...
    .top-sponsor-card .corner-accent.bottom-left {
        bottom: 12px;
        left: 12px;
        border-right: none;
        border-top: none;
    ...
    .top-sponsor-card .corner-accent.bottom-right {
        bottom: 12px;
        right: 12px;
        border-left: none;
        border-top: none;
    ...
    .top-sponsor-image-container img {
        max-width: 100%;
        height: auto;
        max-height: 250px;
        object-fit: contain;
    ...
    .btn-robotic-secondary:hover .btn-icon {
